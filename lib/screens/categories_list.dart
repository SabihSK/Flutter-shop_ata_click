...
class CategoriesList extends StatefulWidget {
  String categoryType;
  CategoriesList({this.categoryType});
  @override
...
class _CategoriesListState extends State<CategoriesList> {
  ...
  //List<String> _title=['Brand new sofa with 3 years of warranty','2020 BMW X5 | Luxuary SUV by Deewan Motors','Beige Fabric Shade Table Lamp with Gold Base','Westfield Solid Oak Chair Brown Leather '];
